...
from auth.jwt_token_verification import verify_token
from auth.singleton_pub_key import ClassicSingleton


async def get_payload_of_jwt_token(authorization: str = Header(None)):
